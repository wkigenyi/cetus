 ...
 * @author Admin
 */
public class EmployeeEducationEditor extends javax.swing.JPanel{
     ...
     */
    public EmployeeEducationEditor(Edu contact){
        this(contact.getEmployeeId(),contact);
    }
    
    public EmployeeEducationEditor(Employees emp){
        this(emp,null);
    }
    
    
 public EmployeeEducationEditor(Employees empID,Edu acc) {
        initComponents();
        //Start transaction
        contact = acc;
        ...
        if(acc != null){
            ...
            try{
            jdcFrom.setDate(new Date(contact.getCFrom()));
            ...
            try{
            jdcTO.setDate(new Date(contact.getCTo()));
            }catch(Exception e){
                StatusDisplayer.getDefault().setStatusText(e.getLocalizedMessage());
            }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jLabel3.text_1")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jLabel1.text_1")); // NOI18N

        jtInsititute.setText(org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jtInsititute.text")); // NOI18N

        jtComment.setColumns(20);
        jtComment.setRows(5);
        jScrollPane1.setViewportView(jtComment);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jLabel2.text_1")); // NOI18N

        jtAward.setText(org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jtAward.text_1")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jLabel4.text_1")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel6, org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jLabel6.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel7, org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jLabel7.text")); // NOI18N

        jtCourse.setText(org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jtCourse.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jbSave, org.openide.util.NbBundle.getMessage(EmployeeEducationEditor.class, "EmployeeEducationEditor.jbSave.text_1")); // NOI18N
...
"           (?,?,?,?,?,?,?)";
            ...
            resetEditor();
            StatusDisplayer.getDefault().setStatusText("Education Added");
            
            Utility.loadEducation(employeeID);
            
        }else{
            
            Edu eba = entityManager.find(Edu.class, contact.getId());
            ...
            if(null != fro){
                eba.setCFrom(fro.toGMTString());
            }
            
            if(null != to){
                eba.setCTo(to.toGMTString());
            }
            ...
            StatusDisplayer.getDefault().setStatusText("Education Saved");
